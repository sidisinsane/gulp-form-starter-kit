...
function js () {
  const bundler = browserify('src/assets/js/app.js', { debug: true })
    .transform(babelify, {
      global: true,
...
function watchFiles (done) {
  ...
  gulp.watch('src/**/*.{css,scss}', gulp.series(css, liveReload));
  gulp.watch('src/**/*.js', gulp.series(js, liveReload));
  gulp.watch(['src/**/*.{html,md,njk,svg}', 'src/**/*.json'], liveReload);
