...
(function () {
  ...
  var placeholderShownPolyfill = {
    init: function () {
      var self = this;
      Array.prototype.slice.call(document.querySelectorAll('[placeholder]')).forEach(function (el) {
    ...
    updatePlaceholder: function () {
      this.classList[(this.value !== null && this.value !== '' && this.value !== undefined) ? 'remove' : 'add']('placeholder-shown');
    }
